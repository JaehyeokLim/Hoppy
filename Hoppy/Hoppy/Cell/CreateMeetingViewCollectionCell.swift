//
//  CreateMeetingViewCollectionCell.swift
//  Hoppy
//
...
class CreateMeetingViewCollectionCell: UICollectionViewCell {
    static let identifier = "CreateMeetingViewCollectionCell"
...
//        layer.shadowOffset = CGSize(width: 10, height: 10)
        ...
        userViewImage.addTarget(CreateMeetingViewController.selectedItemAction, action: #selector(CreateMeetingViewController.selectedItemAction(_:)), for: .touchUpInside)
    }
